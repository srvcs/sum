...
pub struct Config {
    ...
    /// Base URL of the srvcs-add dependency.
    pub add_url: String,
}
...
impl Config {
    pub fn from_vars(
        ...
        Config {
            ...
            add_url: add_url.unwrap_or_else(|| "http://127.0.0.1:8081".to_string()),
        }
    }
...
mod tests {
    ...
    fn defaults_are_sane() {
        ...
        assert_eq!(c.add_url, "http://127.0.0.1:8081");
    }
